...
- **Definition**: The process of formally recording all identified requirements in a structured format that allows clear communication, traceability, and review.
...
- Definition: Evaluating the documented requirements for feasibility, risks, dependencies, conflicts, and alignment with project objectives.
  - PMBOK: Process Group - Planning
  ...
  - Waterfall:
    - Performed after requirements documentation, with focus on potential risks and technical feasibility before moving to the design phase.
  - Agile:
...
- Definition: Ensuring that requirements have been properly implemented and fulfilled. Includes testing, reviews, and validating requirements meet stakeholder needs and comply with standards.
...
- Monitoring & Controlling: Ensuring requirements are met through change
  control processes
...
- Example(s):
  ...
  - Source (e.g., industry standards, regulatory requirements) + Design Specification
  - Test Case ID
...
- Best Practices
  - Continuous Updates: The RTM should be a living document,updated throughout the
    project lifecycle.
  ...
  - Stakeholder Involvement: Involve all relevant stakeholders in the creationand review of the RTM to ensure comprehensive coverage of cybersecurity aspects.
...
- References and Examples
  - ISO/SAE21434: This standard provides guidelines for cybersecurity engineering for road vehicles. Teams can refer to this for specific cybersecurity requirements and best practices.
  - UNECEWP.29:This regulation focuses on cybersecurity and software updates for vehicles. It provides a framework for cybersecurity management systems in the automotive industry.
  - NISTSP800-160: While not specific to automotive,this publication provides a comprehensive set of security controls that can be adapted for automotive cybersecurity.
  - SAEJ3061: This guidebook on cybersecurity for cyber-physical vehicle systems can provide valuable insights for creating comprehensive traceability matrices.
...
- StRS documents typically includes:
  - Introduction
  - Purposeand Scope
  - Assumptions
  - References
  ...
  - Requirements List(ofteninaRVTMformat)
...
Templates: National Archives
https://www.archives.gov/files/contracts/hipgfi/ir-templates/strs-template-v.4.0.docx https://www.archives.gov/files/contracts/hipgfi/ir-templates/example-pmrs2.0-strs-v.1.1-2018may23.docx
